...
The `SubTurn` mechanism is a core feature in EbiClaw that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the EbiClaw `EventBus` for observability and debugging:
