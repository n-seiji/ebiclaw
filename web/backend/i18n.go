...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open EbiClaw console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About EbiClaw",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit EbiClaw",
		Exiting:            "Exiting EbiClaw...",
		DocUrl:             "https://docs.ebiclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 EbiClaw 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 EbiClaw",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 EbiClaw",
		Exiting:            "正在退出 EbiClaw...",
		DocUrl:             "https://docs.ebiclaw.io/zh-Hans/docs/",
	},
}
