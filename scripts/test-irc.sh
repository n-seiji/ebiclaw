...
CONTAINER_NAME="ebiclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.ebiclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run ebiclaw:"
echo "  cd packages/ebiclaw && go run ./cmd/ebiclaw gateway"
echo ""
