#!/bin/bash
# Build macOS .app bundle for EbiClaw Launcher
...
LAUNCHER_EXECUTABLE="ebiclaw-launcher-${EXECUTABLE}"
EXECUTABLE="ebiclaw-${EXECUTABLE}"
echo "executable: $EXECUTABLE"

APP_NAME="EbiClaw Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="ebiclaw-launcher"
...
if [ -f "./build/${EXECUTABLE}" ]; then
    cp "./build/${EXECUTABLE}" "${APP_MACOS}/ebiclaw"
else
...
<dict>
    ...
    <string>ebiclaw-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.ebiclaw.launcher</string>
