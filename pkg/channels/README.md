# EbiClaw Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/ebiclaw/internal/gateway/`
...
import (
    "github.com/n-seiji/ebiclaw/pkg/bus"
    "github.com/n-seiji/ebiclaw/pkg/channels"     // Reference parent package
    "github.com/n-seiji/ebiclaw/pkg/config"
    "github.com/n-seiji/ebiclaw/pkg/identity"      // New
    "github.com/n-seiji/ebiclaw/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/ebiclaw/internal/gateway/helpers.go
import (
    _ "github.com/n-seiji/ebiclaw/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/n-seiji/ebiclaw/pkg/channels/discord"
    _ "github.com/n-seiji/ebiclaw/pkg/channels/your_new_channel"  // New addition
)
```
...
// cmd/ebiclaw/internal/gateway/helpers.go
import (
    _ "github.com/n-seiji/ebiclaw/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom EbiClaw native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
