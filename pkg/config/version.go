...
//
//	-X github.com/n-seiji/ebiclaw/pkg/config.Version=<version>
//	-X github.com/n-seiji/ebiclaw/pkg/config.GitCommit=<commit>
//	-X github.com/n-seiji/ebiclaw/pkg/config.BuildTime=<timestamp>
//	-X github.com/n-seiji/ebiclaw/pkg/config.GoVersion=<go-version>
var (
