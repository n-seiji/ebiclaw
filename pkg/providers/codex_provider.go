...
import (
	...
	orc "github.com/n-seiji/ebiclaw/pkg/providers/openai_responses_common"
)
...
func createCodexTokenSource() func() (string, string, error) {
	return func() (string, string, error) {
		...
		if cred == nil {
			return "", "", fmt.Errorf("no credentials for openai. Run: ebiclaw auth login --provider openai")
		}
